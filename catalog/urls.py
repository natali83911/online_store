...
from .views import (ContactsView, HomeView, ProductCreateView,
...
urlpatterns = [
    ...
    path('products/category/<str:category_name>/', ProductsByCategoryView.as_view(), name='products_by_category'),
]
